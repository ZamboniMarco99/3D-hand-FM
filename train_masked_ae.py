"""Module containing the main function for training the masked autoencoder."""
...
from models.masked_ae import MaskedAutoencoderViT


@hydra.main(config_path="configs", config_name="train_masked_ae.yaml", version_base="1.1")
def main(cfg: DictConfig) -> None:
    """Train masked autoencoder using PyTorch Lightning with Weights & Biases logging and Hydra configuration."""
    # Set up logging
    ...
    datamodule = H2ODataModule(
        ...
        dataset_type="sequence",  # Always use sequence mode for MAE
    )
